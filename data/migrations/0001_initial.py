    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lesson', to='data.lesson')),
        ...
        migrations.AddField(
            model_name='lesson',
            name='product',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='lessons', to='data.product'),
        ),
        migrations.AddField(
            model_name='lesson',
            name='student_time',
            field=models.ManyToManyField(through='data.TimeInfo', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='student',
            name='products',
            field=models.ManyToManyField(related_name='products', to='data.product'),
        ),
        migrations.AddField(
            model_name='student',
